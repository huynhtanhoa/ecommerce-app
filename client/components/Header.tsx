    ...
    return(
        <View className='flex-row items-center justify-between px-4 py-3 bg-white'>
            ...
            <View className='flex-row items-center flex-1'>
                ...
                {/*If there is no logo, the title will be display instead */}
                { showLogo ? (
                    <View className='flex-1'>
                        <Image source={require("@/assets/logo1.png")} style={{width:'100%', height:24}} resizeMode='contain'/>
                    </View>
                ) : title && (
                ...
                {/*
                    - when title is not available and search is not available
                    - it will align menu icon on the left & cart, search icons on the right side
                */}
